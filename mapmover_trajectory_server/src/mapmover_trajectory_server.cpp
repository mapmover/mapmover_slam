...
#include <mapmover_nav_msgs/GetRecoveryInfo.h>
...
public:
  ...
  bool trajectoryProviderCallBack(mapmover_nav_msgs::GetRobotTrajectory::Request  &req,
                                  mapmover_nav_msgs::GetRobotTrajectory::Response &res )
  {
    res = getTrajectory();
    return true;
  }

  inline const mapmover_nav_msgs::GetRobotTrajectoryResponse getTrajectory() const
  {
    return trajectory_;
  }

  bool recoveryInfoProviderCallBack(mapmover_nav_msgs::GetRecoveryInfo::Request  &req,
                                  mapmover_nav_msgs::GetRecoveryInfo::Response &res )
  {
  ...
  mapmover_nav_msgs::GetRobotTrajectory::Response trajectory_;
...
{
  ros::init(argc, argv, "mapmover_trajectory_server");
