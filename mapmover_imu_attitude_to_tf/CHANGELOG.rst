^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package mapmover_imu_attitude_to_tf
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
0.3.4 (2015-11-07)
------------------
* mapmover_imu_attitude_to_tf: fixed default values of the base_frame and base_stabilized_frame parameters (fix #20)
